// Java program to check whether the number is Twisted Prime number or not

import java.util.Scanner;

public class _13_TwistedPrime {
    ...
    // Method to check whether the number is Twisted prime or not
